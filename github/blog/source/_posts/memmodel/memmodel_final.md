...
## 写final域的重排序规则
 ...
 1. JMM(Java Memory Model, Java内存模型)禁止编译器把final域的写重排序到构造函数之外。
...
![执行时序](https://www.github.com/sd1026203/img/raw/master/1493014011136.jpg)
...
## 读final域的重排序规则
 ...
 1. 在一个线程中，初次读对象引用与初次读该对象包含的final域，JMM禁止处理器重排序这两个操作（注意，这个规则仅仅针对处理器）。编译器会在读final域操作的前面插入一个LoadLoad屏障。
...
![enter description here](https://www.github.com/sd1026203/img/raw/master/1493014869480.jpg)
...
![enter description here](https://www.github.com/sd1026203/img/raw/master/1493015580964.jpg)
...
![enter description here](https://www.github.com/sd1026203/img/raw/master/1493017671927.jpg)
...
1. [Java Concurrency in Practice](https://www.amazon.com/Java-Concurrency-Practice-Brian-Goetz/dp/0321349601/ref=pd_sim_b_1)
2. [JSR 133 (Java Memory Model) FAQ](https://www.cs.umd.edu/users/pugh/java/memoryModel/jsr-133-faq.html)
3. [The JSR-133 Cookbook for Compiler Writers](http://gee.cs.oswego.edu/dl/jmm/cookbook.html)
4. [Intel® 64 and IA-32 ArchitecturesvSoftware Developer’s Manual Volume 3A: System Programming Guide, Part 1](http://www.intel.com/content/www/us/en/architecture-and-technology/64-ia-32-architectures-software-developer-vol-3a-part-1-manual.html)